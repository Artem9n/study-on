    ...
    public function load(ObjectManager $manager): void
    {
        $coursesData = [
            ...
            [
                ...
                'description' => 'Курс по моделированию, нормализации и оптимизации баз данных, необходимый для построения надёжных информационных систем.',
                'lessons' => [
                    [
                        'name' => 'Введение в базы данных',
                        'content' => 'Основные понятия баз данных, типы СУБД и роль реляционной модели в современном программировании.',
                        'sort' => 1,
                    ],
                    [
                        'name' => 'Нормализация данных',
                        'content' => 'Процесс нормализации, принципы построения таблиц и предотвращение избыточности данных.',
                        'sort' => 2,
                    ],
                    [
                        'name' => 'Запросы SQL и оптимизация',
                        'content' => 'Основы языка SQL, создание запросов для выборки и модификации данных, а также методы повышения их эффективности.',
                        'sort' => 3,
                    ],
                    [
                        'name' => 'Проектирование распределённых баз данных',
                        'content' => 'Особенности и вызовы при проектировании масштабируемых и распределённых систем хранения данных.',
                        'sort' => 4,
                    ],
                ],
            ],
